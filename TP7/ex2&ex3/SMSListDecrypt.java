...
public class SMSListDecrypt extends SMSList{
    ...
    public void viewDetail(){
        ...
        if(s!=null){
            ...
            if(message.decryptMessage()!=null)System.out.println("index="+index+"\t"+message.decryptMessage());
            else System.out.println("At index "+index+"bad password");
        }else System.out.println("at index "+index+" there is no file");
    }
