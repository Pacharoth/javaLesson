...
public class PopularStore {
    ...
    public void readMenu(){
        ...
        System.out.println("5.Get customers count");
        System.out.println("6.Serve a customer ");
    ...
    public void createDatabse(){
        try {
            ...
            setStmt(statement);
            setConn(conn);
            getStmt().executeUpdate("create database if not exists `i4GIC2020_21`;");
            getStmt().executeUpdate("use `i4GIC2020_21`;");
